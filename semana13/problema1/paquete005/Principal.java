package problema1.paquete005;

import problema1.paquete001.Persona;
import problema1.paquete002.Ciudad;
import problema1.paquete003.BilleteraPagos;
import problema1.paquete004.*;
import problema1.paquete006.DatosAgua;
import problema1.paquete006.DatosLuz;
import problema1.paquete006.DatosPropiedades;
import problema1.paquete006.DatosTelefono;
...
public class Principal {
    public static void main(String[] args) {
        ...
        for (double[] informacion : informacionTelefono) {
            PagoTelefonoConvencional pagoTelefono = new PagoTelefonoConvencional(informacion[0], informacion[1]);
